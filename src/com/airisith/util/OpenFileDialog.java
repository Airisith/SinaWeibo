...
public class OpenFileDialog {  
    ...
    public static Dialog createDialog(int id, Context context, String title, FileOpenCallbackBundle callback, String suffix, Map<String, Integer> images){  
    ...
    static class FileSelectView extends ListView implements OnItemClickListener{  
        ...
        private FileOpenCallbackBundle callback = null;  
        ...
        public FileSelectView(Context context, int dialogid, FileOpenCallbackBundle callback, String suffix, Map<String, Integer> images) {  
            super(context);  
 	 ...
 	 *
 	 */
    public interface FileOpenCallbackBundle {  
